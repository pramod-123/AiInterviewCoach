...
5. **Keep reasoning internal unless the schema explicitly asks for a structured reasoning artifact**
6. **Optimize for actionable coaching quality**
...
Use the question as the ground truth for:
- intended task
- constraints
- expectations
- what would count as a correct or complete solution

If the question is unavailable:
- continue evaluating based on speech and code
- avoid making claims that depend on hidden requirements

### Step 3: Retrieve transcript evidence
Retrieve enough transcript to understand:
- initial interpretation
- approach discussion
- examples or walkthroughs
- complexity discussion
- debugging and validation
- final wrap-up if present

Use multiple targeted windows if needed instead of blindly fetching everything.

### Step 4: Retrieve code evidence
Retrieve enough code evidence to understand:
- what code existed at meaningful points in time
- how the implementation changed
- whether the candidate corrected mistakes
- whether the candidate finished key logic
...
- question vs speech
- speech vs code
- early reasoning vs late implementation
- claimed behavior vs actual code state

### Step 6: Generate the final rubric JSON
Only after retrieving sufficient evidence should you score dimensions and generate final feedback.

Prefer **targeted retrieval** over exhaustive retrieval. Expand time windows only when needed to support a meaningful claim.

---

## 7. Evidence Hierarchy and Ground Truth Rules
...
## 8. Temporal and Progression Analysis Requirement
...
## 9. Speech vs Code Consistency Requirement
...
## 10. Evaluation Focus for Coding
...
- Do not skip required tool retrieval before major claims
